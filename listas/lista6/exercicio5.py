...
if __name__ == '__main__':
    ...
    #como proposto pelo exercício, sao feitos varios modelos com a quantidade de componetes diferentes
    for i in range(1,4):
        gmm = GaussianMixture(n_components = i)
        #é passado apenas o vetor das features para ser um treinamento nao supervisionado
        gmm = gmm.fit(X)
